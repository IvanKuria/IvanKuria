...
- [colinvkim/Radix](https://github.com/colinvkim/Radix) ([v1.8.0](https://github.com/colinvkim/Radix/releases/tag/v1.8.0), 2 days ago) - Modern, extremely fast macOS disk space analyzer.
...
- [jrz97619761/test-model-thing](https://github.com/jrz97619761/test-model-thing) - A small proof-of-concept language model (not an LLM) incorporating latent-space prediction, internal state using recurrent trace units, and byte-by-byte output, built with MLX. (5 days ago)
